...
//!
//! This macro is an attribute macro that need to be place on the `impl block` of a Saphir controller.
//! It has 3 optionnal parameters:
...
//!
//! This one is the attribute to add a endpoitn to your controller, simply add a method and a path above your endpoint function, and there ya go.
//! E.g. `#[get("/users/<user_id>")]` would route its function to /users/<user_id> with the HTTP method GET accepted.
//!
//! We support even custom methods, and for convinience, `#[any(/your/path)]` will be treated as : _any method_ being accepted.
//!
...
//! - `data="path::to::initializer"`  : _Optional_ This is used to instantiate the data that will be passed to the guard function. this function takes a reference of the controller type it is used in.

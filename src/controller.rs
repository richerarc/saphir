...
//! the futures generated by the controller handlers, as 'static. Tis is considered safe since every
//! controller lives within the server stack with has a static lifetime over your application.
